...
enum battle_string_ids {
    ...
    STRING_IN_LOVE,
    STRING_BROKE_FREE,
    STRING_APPEARED_CAUGHT,
    STRING_ALMOST_HAD_IT,
    STRING_SO_CLOSE_TOO,
    STRING_GOTCHA_CAUGHT,
    STRING_TRYING_TO_LEARN_MOVE,
    STRING_FORGET_WHICH_MOVE,
    STRING_STOP_LEARNING_MOVE,
    STRING_CONFIRM_FORGET,
    STRING_FORGOT_SELECTED_MOVE,
    STRING_DISABLED_USED,
    STRING_ABSORBED_ENERGY,
